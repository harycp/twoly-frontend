...
<MobileShell>
    ...
    <PageHeader title="Plans & Calendar" subtitle="Design your next memories">
        {#snippet rightContent()}
            <a aria-label="Create new plan" href={resolve('/date-plans/new')} class="group flex h-11 w-11 items-center justify-center rounded-full bg-gray-900 text-white shadow-[0_8px_20px_-6px_rgba(0,0,0,0.3)] transition-all duration-300 active:scale-90 hover:bg-gray-800 hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.4)]">
