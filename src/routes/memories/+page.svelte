...
<MobileShell>
    <PageHeader title="Camera Roll" subtitle="Your cinematic journey">
        {#snippet rightContent()}
            <div class="flex items-center gap-3">
                <a aria-label="View album" href={resolve('/gallery')} class="flex h-12 w-12 items-center justify-center rounded-full border border-gray-100 bg-white text-gray-500 shadow-sm transition-all duration-300 hover:bg-gray-50 hover:text-gray-900 active:scale-90">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                </a>

                <a aria-label="Add new memory" href={resolve('/memories/new')} class="group flex h-12 w-12 items-center justify-center rounded-full bg-gray-900 text-white shadow-[0_8px_20px_-6px_rgba(0,0,0,0.3)] transition-all duration-300 hover:bg-gray-800 hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.4)] active:scale-90">
    ...
    <main class="px-6 pt-6 pb-32 space-y-6">
        ...
        {:else if memories.length === 0}
            ...
            <div class="mt-8 flex w-full flex-col items-center justify-center rounded-[40px] border-[3px] border-dashed border-[#F8B4C8]/40 bg-white/30 py-20 px-6 text-center backdrop-blur-sm">
                ...
                <div class="relative mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-white shadow-[0_8px_20px_-6px_rgba(253,164,175,0.3)] -rotate-3 transition-all duration-300 hover:rotate-0">
                ...
                <p class="max-w-62.5 text-[15px] font-medium leading-relaxed text-gray-500">
