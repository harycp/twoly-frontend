<script lang="ts">
	...
	let showColorBar = $state(false);
</script>

<div class="fixed bottom-6 left-0 right-0 z-40 mx-auto w-[94%] max-w-md space-y-2 select-none">
	<!-- Top Row: Floating Color & Size Panel (Expandable or inline) -->
	<div
